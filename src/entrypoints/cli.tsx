...
async function main(): Promise<void> {
  ...
  // Fast-path for `agency serve` to bypass interactive Auth checks
  if (args[0] === 'agency' && args[1] === 'serve') {
    ...
    try {
      ...
      console.log(`🌐 خادم الـ API المطور يعمل الآن!`);
      console.log(`🔗 الرابط: ${dashboardUrl}`);
      console.log(`تم فتح لوحة التحكم في متصفحك.`);
